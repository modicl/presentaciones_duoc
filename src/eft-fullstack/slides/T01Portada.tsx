...
export default function T01Portada() {
  return (
    <div className="relative w-full h-full flex overflow-hidden" style={{ backgroundColor: 'var(--bg)' }}>
      ...
      <div className="flex flex-col justify-center pl-16 pr-10 py-10 flex-[3] min-w-0">
        ...
        <h2 className="font-heading text-5xl font-bold leading-tight mb-4" style={{ color: 'var(--text)' }}>
          Defensa de Arquitectura · PRISMA
        </h2>
        <div className="mb-3">
          {[
            ['P', 'lataforma de'],
        ...
        <p className="font-body text-base mb-6" style={{ color: 'var(--text-label)' }}>
          Microservicios NestJS · SPA React (BFF) · Motor IA multi-agente (HITL) para generación de PACI
        </p>
        ...
        <div className="font-body space-y-3">
          ...
          <p className="text-sm pt-2" style={{ color: 'var(--text-dim)' }}>
            Evaluación Final Transversal &nbsp;·&nbsp; Defensa oral (15 min)
          </p>
        </div>
      </div>
