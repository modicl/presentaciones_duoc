...
import Ep3PdfView from './Ep3PdfView'
import '../../pdf/pdf.css'

export async function downloadEp3Pdf(onProgress?: (msg: string) => void): Promise<void> {
  ...
  root.render(createElement(Ep3PdfView))
  ...
  pdf.save('Presentacion_EP3_RedNorte.pdf')
