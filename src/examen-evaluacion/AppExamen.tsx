...
import X01Portada from './slides/X01Portada'
import X02Contexto from './slides/X02Contexto'
import X03FODA from './slides/X03FODA'
import X04Alternativas from './slides/X04Alternativas'
import X05Matriz from './slides/X05Matriz'
import X06Organizacion from './slides/X06Organizacion'
import X07Riesgos from './slides/X07Riesgos'
import X08CAPEX from './slides/X08CAPEX'
import X09FlujoCaja from './slides/X09FlujoCaja'
import X10Prestamo from './slides/X10Prestamo'
import X11Indicadores from './slides/X11Indicadores'
import X12Recomendacion from './slides/X12Recomendacion'
...
export default function AppExamen() {
    ...
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-[3px]" style={{ backgroundColor: 'var(--border)' }}>
        <div
          ...
          style={{ width: `${progress}%`, backgroundColor: '#307FE2' }}
        />
      </div>
